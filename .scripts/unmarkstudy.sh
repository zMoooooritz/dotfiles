...
magick -density 300 $1 -quality 100 "$tmp_dir/page_%04d.jpg"
magick mogrify -path "$tmp_dir" -strokewidth 0 -fill "#ffffff" -draw "rectangle 600,3100 1800,3250" "$tmp_dir/*.jpg"
